<?php
if(!defined('ABSPATH'))exit;define('NBU_T_VER','1.16.0');
...
function nbu_t_login_title($title){return get_bloginfo('name').' â Sign in';}add_filter('login_headertext','nbu_t_login_title');
...
$scanDensity=absint(get_theme_mod('nbu_t_crt_scanlines',35));$scanAlpha=min(70,round($scanDensity*0.7));$scanGap=max(2,round(6-($scanDensity/100)*4));
$x.='--crt-scan-gap:'.$scanGap.'px;--crt-scan-alpha:'.$scanAlpha.'%;';
